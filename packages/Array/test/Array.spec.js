...
describe("Array", () => {
  ...
  describe("#insertionSort", () => {
    ...
    it("should insertion in descending order with a custom comparator", () => {
      array = new Array([3, 7, 1, 9, 3, 7]);
      array.insertionSort((a, b) => b - a);
    ...
    it("should insertion in ascending string length order with a custom comparator", () => {
      array = new Array(["1111", "11111", "1", "11", "111"]);
      array.insertionSort((a, b) => a.length - b.length);
    ...
    it("should insertion in descending string length order with a custom comparator", () => {
      array = new Array(["1111", "11111", "1", "11", "111"]);
      array.insertionSort((a, b) => b.length - a.length);
  ...
  describe("#selectionSort", () => {
    ...
    it("should selection in descending order with a custom comparator", () => {
      array = new Array([3, 7, 1, 9, 3, 7]);
    ...
    it("should selection in ascending string length order with a custom comparator", () => {
      array = new Array(["1111", "11111", "1", "11", "111"]);
      array.selectionSort((a, b) => a.length - b.length);
    ...
    it("should selection in descending string length order with a custom comparator", () => {
      array = new Array(["1111", "11111", "1", "11", "111"]);
      array.selectionSort((a, b) => b.length - a.length);
