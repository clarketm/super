...
describe("MergeSort", () => {
  ...
  describe("#mergeSort", () => {
    it("should merge a six (6) items array", () => {
      array = [3, 7, 1, 9, 3, 7];
    ...
    it("should merge a four (4) items array", () => {
      array = [1, 9, 2, 5];
    ...
    it("should merge a six (2) items array", () => {
      array = [8, 6];
    ...
    it("should merge a one (1) item array", () => {
      array = [4];
    ...
    it("should merge in descending order with a custom comparator", () => {
      ...
      actual = mergeSort(array, (a, b) => b - a);
    ...
    it("should merge in ascending string length order with a custom comparator", () => {
      ...
      actual = mergeSort(array, (a, b) => a.length - b.length);
    ...
    it("should merge in descending string length order with a custom comparator", () => {
      ...
      actual = mergeSort(array, (a, b) => b.length - a.length);
  ...
  describe("#Array.mergeSort", () => {
    ...
    it("should merge a two (2) items array", () => {
      array = [8, 3];
    ...
    it("should merge a one (1) items array", () => {
      array = [5];
